  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
        ...
        <div className="w-full px-6 py-8">
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
            ...
            <div className="flex gap-3">
              <div className="h-11 w-36 bg-slate-900 dark:bg-slate-100 rounded"></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full px-6 py-8 space-y-8">
        ...
        {/* Legal Cases Table */}
        <div className="bg-card rounded-xl border border-slate-200/50 dark:border-slate-800/50 shadow-sm">
          <div className="bg-slate-50 dark:bg-slate-800/50 border-b border-border px-6 py-4">
          ...
          <div className="p-0">
            {[...Array(6)].map((_, i) => (
              <div key={i} className="px-6 py-4 border-b border-border last:border-0 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
